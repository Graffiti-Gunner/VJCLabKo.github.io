...
function showMein(time) {
    ...
    document.getElementById("masthead-content").style.display = "none";
...
function showPage() {
    ...
    document.getElementById("global-nav").style.display = "block";
    document.getElementById("global-footer").style.display = "block";
    document.getElementById("masthead-content").style.display = "block";
    loaded = true;
};